	...
	public class BundleConfig
	{
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/lib")
                ...
                .Include(lteplugins + "jquery.bootstrapvalidator/js/bootstrapValidator.min.js")
                ...
                .Include(lteplugins + "toastr.js/toastr.min.js")
            ...
            bundles.Add(new StyleBundle("~/Content/css")
                ...
                .Include(lteplugins + "jquery.bootstrapvalidator/css/bootstrapValidator.min.css")
                ...
                .Include(lteplugins + "toastr.js/toastr.min.css")
